      ...
      <div class="login-body">
        <el-form class="login-form" ref="signInForm" :model="formData" :rules="signInFormRules">
          <el-form-item class="form-item" prop="account">
            <el-input type="text" v-model="formData.account" placeholder="请输入用户名">
            </el-input>
          </el-form-item>
          <el-form-item class="form-item" prop="password">
            <el-input :type="passwordInputType" v-model="formData.password" placeholder="请输入密码，回车登录" @on-enter="handleSignIn">
            <el-button slot="append" :icon="passwordInputType === 'password' ? 'eye-disabled' : 'eye'" style="font-size: 16px; line-height: 1;" @click="showPassword"></el-button>
            </el-input>
          </el-form-item>
        </el-form>
    ...
    return {
      ...
      signInFormRules: {
        ...
        password: [
          ...
          { type: 'string', min: 5, max: 16, message: '密码长度必须在5到16位之间', trigger: 'change' }
        ]
      },
      // 密码输入框类型
