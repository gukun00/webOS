...
<template>
  ...
  >
    <img :class="{ 'desktop-icon-down': isMouseDown}" v-if="info.config.app.icon" :src="info.config.app.icon || appIcon" :data-name="info.appName || info.config.app.name">
    ...
    <span v-if="showTitle" :data-name="info.appName || info.config.app.name">{{ info.appTitle || info.config.app.title }}</span>
